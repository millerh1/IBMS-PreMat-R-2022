...
# Challenge: What is the remainder of 14 divided by 3?
...
# Challenge: what is the result of executing "went_to_store_and_bought_cheese"?
...
# Challenge: What is the class of "hi"? 
hi <- c('Hello', 'World!')
...
# Getting the rownames and colnames
rownames(my_df)
colnames(my_df)

# Setting the rowames and colnames
...
# Challenge: What happens if vec1 and vec2 aren't the same length when you add them? Why?
...
# Challenge: Can you design a while loop that will never end?
